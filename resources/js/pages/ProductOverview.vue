                ...
                <ol role="list" class="flex items-center space-x-4">
                    <li>
                        <div class="flex items-center">
                            <a href="#" class="mr-4 text-sm font-medium text-gray-900">Accessories</a>
                    ...
                    <div class="lg:col-span-5 lg:col-start-8">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 flex">
                                    <a href="#" class="text-sm font-medium text-indigo-600 hover:text-indigo-500">See all {{product?.reviews}} reviews</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        addToCart () {
            const vm = this
            const {categories, features, ...product} = vm.product
            axios.post(`/api/marketplace/cart`, {item: product})
                .then(() => {
